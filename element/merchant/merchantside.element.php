...
<div class="wrapper">
  <div class="sidebar">
    <ul>
      <li><a href="../../pages/merchant/home.merchant.php" class="link-text"><i class="fas fa-columns"></i>Dashboard</a></li>
      <li><a href="../../pages/merchant/products.merchant.php" class="link-text"><i class="fas fa-book-open"></i>My Products</a></li>
    </ul>
  </div>
</div>
